...
SELECT 'seed-tx-signed-01', id, 'seed-esc-signed', 'LOCK', 4100000.00, 'VND', 'Lock buyer payment.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-signed';

-- FULLY_LOCKED (active): 2 tx
INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-active-01', id, 'seed-esc-active', 'LOCK', 22000000.00, 'VND', 'Lock buyer payment.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-active';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-active-02', id, 'seed-esc-active', 'LOCK', 2200000.00, 'VND', 'Lock seller deposit.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-active';

-- FULLY_LOCKED (delivered): 2 tx
INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-delivered-01', id, 'seed-esc-delivered', 'LOCK', 17400000.00, 'VND', 'Lock buyer payment.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-delivered';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-delivered-02', id, 'seed-esc-delivered', 'LOCK', 1740000.00, 'VND', 'Lock seller deposit.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-delivered';

-- RELEASED (settled): 4 tx — LOCK x2, RELEASE, REFUND_TO_SELLER
INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-settled-01', id, 'seed-esc-settled', 'LOCK', 7800000.00, 'VND', 'Lock buyer payment.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-settled';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-settled-02', id, 'seed-esc-settled', 'LOCK', 780000.00, 'VND', 'Lock seller deposit.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-settled';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-settled-03', id, 'seed-esc-settled', 'RELEASE', 7800000.00, 'VND', 'Release buyer payment to seller.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-settled';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-settled-04', id, 'seed-esc-settled', 'REFUND_TO_SELLER', 780000.00, 'VND', 'Refund seller deposit.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-settled';
...
INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-cancelled-01', id, 'seed-esc-cancelled', 'LOCK', 34000000.00, 'VND', 'Lock buyer payment.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-cancelled';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-cancelled-02', id, 'seed-esc-cancelled', 'LOCK', 3400000.00, 'VND', 'Lock seller deposit.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-cancelled';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-cancelled-03', id, 'seed-esc-cancelled', 'PENALIZE_BUYER', 6800000.00, 'VND', 'Penalize buyer payment to seller.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-cancelled';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-cancelled-04', id, 'seed-esc-cancelled', 'REFUND_TO_BUYER', 27200000.00, 'VND', 'Refund buyer payment.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-cancelled';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-cancelled-05', id, 'seed-esc-cancelled', 'REFUND_TO_SELLER', 3400000.00, 'VND', 'Refund seller deposit.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-cancelled';

-- FULLY_LOCKED (disputed): 2 tx — chờ Admin gọi PUT /arbitrate
INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-disputed-01', id, 'seed-esc-disputed', 'LOCK', 18750000.00, 'VND', 'Lock buyer payment.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-disputed';

INSERT IGNORE INTO escrow_transactions (transaction_id, escrow_account_id, escrow_id, transaction_type, amount, currency, note, created_at)
SELECT 'seed-tx-disputed-02', id, 'seed-esc-disputed', 'LOCK', 1875000.00, 'VND', 'Lock seller deposit.', NOW()
FROM escrow_accounts WHERE escrow_id = 'seed-esc-disputed';
