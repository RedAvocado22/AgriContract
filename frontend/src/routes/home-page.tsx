  ...
  return (
    <div className="sticky top-0 z-10 flex h-16 items-center gap-8 border-b-[0.5px] border-border bg-surface px-10">
      ...
      <nav className="flex gap-[26px] text-sm text-text-secondary">
        <a href="#">Sàn nguồn hàng</a>
        <a href="#">Bảng giá tham khảo</a>
      ...
      <div className="mx-auto grid max-w-[1160px] grid-cols-[1.15fr_1fr] items-center gap-14 px-10 pt-[72px] pb-[76px]">
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 rounded-[9px] border border-white/35 px-6 py-[13px] text-[15px] font-medium text-white"
            >
