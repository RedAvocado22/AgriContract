...
| `RUBBER` | Không có nguồn mở tương đương | Admin nhập tay |
...
- **`RUBBER`/`CASHEW` phụ thuộc hoàn toàn Admin nhập tay** — không có nguồn tự động, sai sót là lỗi con người, không có validation chéo.
...
_Design session: 05/07/2026 · Chưa code · Chưa đưa vào Architecture/SDS/TechnicalSpec chính thức._
