...
**Chưa đóng — 1 điểm còn treo (cập nhật 08/07/2026):** điểm treo (1) ngưỡng NDVI đã **GỠ** nhờ chuyển sang baseline ForTy/Natural Forests làm sẵn (L2, §2.2.4). Còn lại: `geoVerificationTimeoutHours` là placeholder 4-6h, chưa vận hành thật để kiểm chứng. Xem chi tiết ở §2.2.4.
...
Product Phase 2 (Farm Plot Geolocation) — **đóng session, sẵn sàng đưa vào Architecture/SDS/TechnicalSpec chính thức**, ngoại trừ **1 điểm treo còn lại**: `geoVerificationTimeoutHours` placeholder 4-6h chưa vận hành thật để kiểm chứng (§2.2.4). Điểm treo "ngưỡng NDVI" đã đóng nhờ L2.
