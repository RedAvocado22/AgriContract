...
**`INCONCLUSIVE` — outcome thứ 3, mới 06/07/2026:** ảnh vệ tinh quang học không nhìn xuyên mây được (Tây Nguyên/Đông Nam Bộ mây phủ dày mùa mưa), và nông dân Việt Nam phổ biến trồng xen canh nhiều tầng (cà phê dưới tán sầu riêng, cao su tái canh xen cây ngắn ngày) — cả 2 khiến thuật toán đọc nhiễu chỉ số thực vật, dễ kết luận sai thành phá rừng dù đất canh tác hợp pháp lâu đời. Khi API trả về tín hiệu nhiễu/không đủ tin cậy để phân loại nhị phân → `geoRiskLevel = INCONCLUSIVE`, khác `HIGH_RISK` (có bằng chứng rủi ro) và khác `UNVERIFIED` (chưa có câu trả lời gì — lỗi kỹ thuật/timeout, §2.2.4 dưới) — đây là **API đã trả lời, nhưng câu trả lời không đủ rõ để kết luận**.
...
**Chưa đóng — 2 điểm còn treo (06/07/2026):** (1) ngưỡng NDVI phân biệt rừng/không rừng chưa chốt, cần thực nghiệm; (2) `geoVerificationTimeoutHours` là placeholder 4-6h, chưa vận hành thật để kiểm chứng. Xem chi tiết đầy đủ ở §2.2.4.

Product Phase 2 (Farm Plot Geolocation) — **đóng session, sẵn sàng đưa vào Architecture/SDS/TechnicalSpec chính thức**, ngoại trừ bổ sung 06/07/2026 (geo-risk verification qua vệ tinh, xem ngay trên) — phần này **chưa đóng**, còn 2 điểm treo cần giải quyết trước khi coi là chốt cứng.
