...
description: "Reputation-service — lock ledger bất biến + reputation score, phục vụ lockout enforcement, search ranking, và credit reference export. Nguồn: design session 04/07/2026."
...
- **`FlagSuspiciousPatternUseCase`** — tính composite fraud score (§8), theo cặp buyer-seller/account, publish event hold khi vượt ngưỡng.
...
Reputation-service — **đóng session, sẵn sàng đưa vào Architecture/SDS/TechnicalSpec chính thức.**

---

*Design session: 04/07/2026 · Cập nhật: 04/07/2026 (đóng KI-1, note ưu tiên circuit breaker `sign()`, xác nhận lại giới hạn AML hold) · Chưa code · Chưa đưa vào Architecture/SDS/TechnicalSpec chính thức.*
