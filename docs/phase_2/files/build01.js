...
push(P("Ba yếu tố bên ngoài đang hội tụ, làm nhu cầu số hoá tầng hợp đồng trở nên cấp thiết hơn: quy định chống phá rừng của EU (EUDR) với mốc áp dụng 30/12/2026 cho doanh nghiệp lớn/vừa và 30/6/2027 cho phần lớn doanh nghiệp nhỏ/siêu nhỏ, áp lực chuẩn hoá quy trình ở quy mô xuất khẩu 70 tỷ USD, và chính sách chuyển đổi số nông nghiệp quốc gia còn cách mục tiêu 20 điểm phần trăm. Các yếu tố này tạo nhu cầu compliance và quản trị dữ liệu; chúng không tự động chứng minh doanh nghiệp sẽ chọn hoặc trả tiền cho AgriContract."));
push(P("Trong phạm vi rà soát công khai hiện tại, chưa tìm thấy giải pháp tại Việt Nam giải quyết đồng thời tầng hợp đồng, ký quỹ trung lập, tranh chấp phân tầng và gói traceability hỗ trợ EUDR ở tầng HTX/SME. AgriContract được định vị để kiểm chứng khoảng trống này, với phạm vi giới hạn có chủ đích ở tầng hợp đồng — không phải logistics, không phải sàn thương mại điện tử, không thay thế hệ thống kế toán. Về dài hạn, audit trail tích luỹ trên nền tảng trở thành lịch sử tín dụng có thể xác minh — hạ tầng dữ liệu mà ngân hàng cần để chuyển từ cho vay theo tài sản thế chấp sang cho vay theo dữ liệu giao dịch."));
...
push(H2("1.5 Kỷ luật định lượng TAM/SAM/SOM — không đồng nhất kim ngạch với thị trường phần mềm"));
push(P("Kim ngạch xuất khẩu 70,09 tỷ USD chứng minh quy mô và mức độ quan trọng của chuỗi nông sản, nhưng không phải TAM của AgriContract. Quy mô thị trường phần mềm phải được dựng bottom-up từ số tổ chức có khả năng mua, số hợp đồng phù hợp hoặc GMV thực sự đi qua nền tảng."));
push(table(
  [1300, 2900, 3000, 2438],
...
push(P([runs("Trạng thái hiện tại — ", { bold: true }), runs("Tài liệu chưa có dữ liệu đủ để gắn một con số TAM/SAM/SOM đáng tin cậy. Công thức được chốt trước; con số chỉ được điền sau khảo sát sơ cấp và báo giá thử nghiệm, tránh lấy kim ngạch xuất khẩu nhân một tỷ lệ tuỳ ý.", {})]));
...
push(P([runs("Phá hợp đồng không phải giả định của nhóm — báo chí và cơ quan quản lý gọi thẳng tên (“bẻ kèo”) trong năm 2026. ", { bold: true }), runs("Đài Tiếng nói Việt Nam (06/2026) mô tả tình trạng nông dân rũ bỏ cam kết đã ký khi thương lái đẩy giá, và nhấn mạnh rằng khi phá hợp đồng xảy ra thì gần như không tồn tại cơ chế pháp lý đủ mạnh để bảo vệ quyền lợi — đây chính là khoảng trống mà AgriContract lấp. Báo Đắk Lắk (2024) ghi nhận điệp khúc “chặt–trồng, bẻ cọc, bẻ kèo” phá vỡ liên kết ngay tại vùng cà phê Tây Nguyên, thị trường lõi của hệ thống.", {})]));
push(P([runs("Hiện tượng xảy ra theo cả hai chiều — nền tảng cho thiết kế đối xứng. ", { bold: true }), runs("Tạp chí Kinh tế Môi trường (VFC, 06/2026) xác nhận hợp đồng bao tiêu bị phá vỡ ở cả hai phía: khi giá thị trường vượt giá hợp đồng, một bộ phận nông dân bán ra ngoài; khi giá xuống dưới giá đã ký, một số doanh nghiệp từ chối thu mua hoặc ép giá lại. Vụ doanh nghiệp viện “bất khả kháng” không thu mua khoảng 2.000 tấn đu đủ như cam kết là ví dụ cụ thể cho nhánh doanh nghiệp phá hợp đồng. Đây là căn cứ thực tế cho cơ chế penalty/lock đối xứng của AgriContract — cả bên mua lẫn bên bán đều chịu ràng buộc, không phải chỉ bảo vệ một phía.", {})]));
push(P([runs("Benchmark quốc tế xác nhận side-selling là rủi ro có thể đo được, nhưng không được dùng thay cho số liệu Việt Nam. ", { bold: true }), runs("Nghiên cứu chuỗi malt barley tại Ethiopia ước tính khoảng 30% sản lượng bị side-selling; nghiên cứu trên 370 hộ cao su tại Ghana ghi nhận 20% nông hộ tham gia contract farming có side-selling. Các nghiên cứu đồng thời chỉ ra nguyên nhân không chỉ là đạo đức cá nhân mà gồm giá spot vượt giá hợp đồng, chậm thanh toán, thiết kế hợp đồng thiếu linh hoạt và giá trị quan hệ tương lai chưa đủ lớn. Đây là bằng chứng hỗ trợ hướng thiết kế incentive của AgriContract, không phải bằng chứng rằng tỷ lệ vi phạm tại Việt Nam cũng là 20–30%.", {})]));
push(src("Alemu, Guinan & Hermanson (2021), DOI 10.1080/09614524.2020.1860194; Ewusi Koomson et al. (2022), DOI 10.1080/14728028.2022.2079007; Macchiavello (2022), DOI 10.1146/annurev-economics-051420-110722."));
...
push(P("Nhìn theo trục “tầng giá trị” thay vì từng sản phẩm, rà soát công khai hiện tại chưa tìm thấy đối thủ tại Việt Nam phủ đồng thời ba năng lực AgriContract nhắm tới — ký quỹ số hoá, hợp đồng tự thực thi theo milestone và tranh chấp ba cấp:"));
push(table(
...
push(table(
  ...
  [
    ["Thiếu bằng chứng hợp đồng", "Chỉ 30% liên kết bền chắc; phần còn lại dựa vào thoả thuận miệng hoặc tin nhắn khó chứng minh đầy đủ", "Hợp đồng điện tử với timestamp, lịch sử đàm phán bất biến, audit trail và gói bằng chứng hỗ trợ DDS có thể xuất để hỗ trợ chứng minh hoặc kiểm toán EUDR", "Luật GDĐT 2023, Điều 8, 14, 34–36"],
    ["Không có cơ chế giữ tiền trung lập", "Không có bên thứ ba giữ tiền; bên có lợi thế thường trì hoãn thanh toán hoặc từ chối nhận hàng", "Tiền cọc giữa các bên được thỏa thuận trong hợp đồng; phần tiền thực hiện nghĩa vụ được ngân hàng giữ tại tài khoản phong toả và giải ngân theo workflow đã ký", "BLDS 2015, Điều 328 và 330; Luật TM 2005, Điều 300"],
    ["Thiếu thông tin đối tác", "Không có lịch sử giao dịch số hoá; HTX lần đầu hợp tác không có cơ sở đánh giá độ tin cậy", "Audit trail tích luỹ thành credit history; reputation scoring sau mỗi hợp đồng; INSPECTOR xác nhận chất lượng độc lập", "Luật GDĐT 2023, khoản 2 Điều 14"],
  ],
  { size: 18 }
));
...
push(table(
  ...
  [
    ...
    ["Bộ luật Dân sự 2015", "Điều 328 — đặt cọc; Điều 330 — ký quỹ tại tài khoản phong toả của tổ chức tín dụng; Điều 142 — đại diện; Điều 403 — tự do giao kết; Điều 156 & 351 — bất khả kháng", "Phân biệt tiền cọc giữa các bên với khoản tiền do ngân hàng giữ trong tài khoản phong toả; đồng thời làm cơ sở xác minh thẩm quyền và xử lý bất khả kháng"],
...
push(H2("8.1 Gói validation sơ cấp cần hoàn thành trước khi khẳng định product–market fit"));
push(P("Các con số dưới đây là mục tiêu mẫu đề xuất cho vòng discovery, không phải kết quả khảo sát đã thực hiện. Mục tiêu là biến các giả thuyết “bẻ kèo phổ biến”, “anchor buyer sẵn sàng trả tiền” và “ngân hàng có thể tham gia” thành dữ liệu có thể kiểm chứng."));
push(table(
  [1700, 1800, 3338, 2800],
  ["Nhóm", "Mẫu mục tiêu", "Dữ liệu cần thu", "Quyết định được mở khoá"],
  [
    ["HTX", "20–30", "Số hợp đồng/vụ; giao thiếu, giao muộn, side-selling; thiệt hại; khả năng nộp cọc", "Pain frequency, seller adoption, ngưỡng cọc khả thi"],
    ["Doanh nghiệp thu mua/xuất khẩu", "10–15", "Tỷ lệ đứt hợp đồng; chi phí mua bù; tranh chấp; ngân sách compliance; WTP", "ICP, buyer, pricing và ROI"],
    ["Tổ chức giám định", "3–5", "Biểu phí, SLA, trách nhiệm pháp lý, khả năng nhận case qua nền tảng", "Tính khả thi của dispute tier và unit economics"],
    ["Ngân hàng/chi nhánh", "2–3", "Mô hình tài khoản phong toả/thu hộ, điều kiện API, phân định trách nhiệm lệnh giải ngân", "Khả năng tích hợp thật và ranh giới pháp lý"],
  ],
  { size: 17 }
));
push(P("Bộ biến tối thiểu nên gồm: số hợp đồng mỗi vụ, tỷ lệ vi phạm theo loại, chênh lệch giá tại thời điểm vi phạm, thời gian giải quyết tranh chấp, thiệt hại trực tiếp, chi phí pháp lý, tần suất giao dịch lặp lại và chủ thể có ngân sách. Không dùng câu trả lời định tính “có nhu cầu” thay cho số vụ, giá trị thiệt hại và mức sẵn sàng chi trả."));
...
push(H3("Nghiên cứu học thuật quốc tế"));
[
...
Packer.toBuffer(doc).then(buf => {
  writeDocx("/tmp/AgriContract_01_PhanTichThiTruong_v5.docx", buf);
});
